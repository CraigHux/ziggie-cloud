...
## ROLE
Visual consistency guardian and style enforcement specialist for Ziggie
...
**Read/Write Access:**
- C:\ziggie\assets\ (all subdirectories)
- C:\ziggie\design-docs\art-bible.md
- C:\ziggie\design-docs\color-palettes.json
- C:\ziggie\design-docs\asset-manifest.json
...
### Style References
- C:\ziggie\ref-docs\art-bible.md
- C:\ziggie\assets\characters\openart-image_IjlBBV1k_1762362042794_raw.jpg (Meow Ping reference)
- C:\ziggie\ref-docs\style-reference-sheet.png
...
2. Locate assets:
   - C:\ziggie\assets\characters\cats\hero-meowping\upgraded\
